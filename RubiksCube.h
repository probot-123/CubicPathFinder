//
// Created by Yash Chaurasia on 06/6/24.
//

#ifndef RUBIKS_CUBE_SOLVER_RUBIKSCUBE_H     //to prevent multiple inclusions of the same header file
#define RUBIKS_CUBE_SOLVER_RUBIKSCUBE_H     //deifned header file
